...
# Takes a corpus of documents, returns a set of vectors weighted by TF-IDF
vectorizer = TfidfVectorizer(max_df=0.5,min_df=2,stop_words='english')
X = vectorizer.fit_transform(documentCorpus)
# Specify the number of clusters, how the means are initialized, and the number of iterations
